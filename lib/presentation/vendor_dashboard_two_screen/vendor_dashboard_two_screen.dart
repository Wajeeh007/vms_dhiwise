...
class VendorDashboardTwoScreen extends GetWidget<VendorDashboardTwoController> {
  const VendorDashboardTwoScreen({Key? key})
      : super(
          key: key,
        );
        ...
        children: [
          Padding(
            ...
            child: CustomDropDown(
              ...
              items: controller
                  .vendorDashboardTwoModelObj.value.dropdownItemList!.value,
              onChanged: (value) {
